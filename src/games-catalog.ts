...
export interface GameManifest {
  ...
  preview: string;
  implemented: boolean;
  // Gallery-installed games can be uninstalled straight from the hub;
...
// gallery catalog with which games are already installed by default).
...
// gallery, see game-installer.ts) - nothing here is hand-duplicated per
